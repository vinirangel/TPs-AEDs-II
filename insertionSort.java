...
public class insertionSort{
	...
	public void sort()
	{
		for(int i = 1;  i < quantidade; i++)
		{
			...
			{
				comp+=2;
				array[j+1] = array[j+1].clone(array[j]);
				mov++;
				j--;
			}
			array[j+1] = tmp;
	...
	public static void main (String[] Args)
	{
		...
		insertionSort lista = new insertionSort(100);
		...
		Arq.openWriteClose("668007_insercao.txt", "UTF-8", "Matricula: 668007\t"+"Tempo de execucao:\t"+execTime+"\t"+"Movimentacoes: \t"+lista.mov+"\tComparacoes:\t"+lista.comp);
	}
}
